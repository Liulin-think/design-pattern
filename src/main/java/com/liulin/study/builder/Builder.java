...
public interface Builder<C, S> {
	...
	abstract void BuilderSomeThing(Class<? extends C> c, Class<? extends S> s) throws InstantiationException, IllegalAccessException;
}
